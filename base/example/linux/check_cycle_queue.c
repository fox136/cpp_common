...
namespace check_cycle_queue
{
    static int i = 0;

    const static int NUM = 100000;
    static common_cplus::CCycleQueue<int> que;
...
int main()
{
    std::cout  << check_cycle_queue::check_cycle_queue() << std::endl;
    return 0;
}
#endif
